...
- Never expose a service-role key or database URL to browser code. Runtime uses only the public Supabase URL/key and an optional server-only demo-mode flag.
